export default function DepartmentManageSkeleton() {
  return (
    <>
      {/* Breadcrumb Skeleton */}
      <div className="mb-6">
          ...
          <div key={index} className="rounded-2xl border border-gray-200 bg-white px-6 py-5 dark:border-gray-800 dark:bg-white/[0.03]">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="p-3 bg-gray-200 dark:bg-gray-700 rounded-xl w-12 h-12 animate-pulse" />
          ...
          <div className="overflow-hidden bg-white dark:bg-white/[0.03] rounded-xl">
            ...
            <div className="flex flex-col gap-2 px-4 py-4 border border-b-0 border-gray-100 dark:border-white/[0.05] rounded-t-xl sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                <div className="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse w-16" />
                <div className="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse w-16" />
              </div>
              <div className="h-11 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse w-64" />
            </div>
            ...
            <div className="border border-t-0 rounded-b-xl border-gray-100 py-4 pl-[18px] pr-4 dark:border-white/[0.05]">
              <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
                ...
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map((index) => (
                    <div key={index} className="h-10 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse w-10" />
                  ))}
                </div>
              </div>
            </div>
