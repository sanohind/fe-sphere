          ...
          <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-1 gap-y-8 lg:items-center lg:grid-cols-2 sm:gap-y-20 xl:grid-cols-5">
              <div className="text-center xl:col-span-2 lg:text-left md:px-16 lg:px-0">
                  ...
                  <div className="mt-8 lg:mt-12 lg:flex lg:items-center">
                    <div className="flex justify-center flex-shrink-0 -space-x-4 overflow-hidden lg:justify-start">
                      <img
                        ...
                        src="/images/logo/ams-logo-04.png"
                        alt=""
                      />
                      <img
                        className="inline-block rounded-full w-14 h-14 ring-2 ring-white dark:ring-gray-800"
                        src="/images/logo/SCOPE-05.png"
                        alt=""
                      />
                      <img
                        className="inline-block rounded-full w-14 h-14 ring-2 ring-white dark:ring-gray-800"
                        src="/images/logo/SPHERE logo-01.png"
                        alt=""
                      />
                    </div>

                    <p className="mt-4 text-lg text-gray-900 dark:text-gray-300 lg:mt-0 lg:ml-4 font-pj w-[300px]">
                      A single platform to manage, monitor, and move faster.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 sm:flex sm:items-center sm:justify-center lg:justify-start sm:space-x-5 lg:mt-12">
                  <button
                    ...
                    className="inline-flex items-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-gray-900 dark:bg-gray-800 dark:border-gray-700 border border-transparent rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 dark:focus:ring-gray-700 font-pj justif-center hover:bg-gray-700 dark:hover:bg-gray-700"
                  >
                    Get Started
                  </button>
                </div>
              ...
              <div className="xl:col-span-3">
                ...
                <img className="w-full mx-auto scale-110" src="/images/brand/sanoh-hero-10.png" alt="" />
              </div>
            </div>
          </div>
        </section>
